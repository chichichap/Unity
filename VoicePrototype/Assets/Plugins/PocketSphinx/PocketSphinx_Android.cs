...
namespace UnityPocketSphinx
{
    public class PocketSphinx_Android : IPocketSphinx
    {
        ...
        public void AddKeywordSearchPath(string searchKey, string keywordPath) {
            Debug.Log("[PocketSphinx_Android] Calling AddKeywordSearchPath()");
            CallPocketSphinxMethod("AddKeywordSearchPath", searchKey, keywordPath);
        }
